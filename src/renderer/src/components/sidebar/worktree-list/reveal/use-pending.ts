...
import { getRenderRowOptionId } from '../viewport/active-descendant-option'
import {
  findPreferredRenderRowIndexForWorktree,
  getRenderRowSidebarKey,
  rowKeyMatchesRenderRow
} from '../rows/render-row-lookup'
import { revealMountedSidebarRowElement, revealMountedWorktreeElement } from './mounted-row'
import { getSidebarRowRevealAncestorKeys } from './ancestors'
import { sidebarWorkspaceStillExists } from './folder-reveal'
import { resolvePendingSidebarReveal } from '../scroll/tuning'
import {
